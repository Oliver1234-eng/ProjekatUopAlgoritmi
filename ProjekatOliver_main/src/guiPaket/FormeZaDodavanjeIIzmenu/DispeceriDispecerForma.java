...
public class DispeceriDispecerForma extends JFrame {
		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(validacija()) {
					...
					//DODAVANJE
					if (dispecer == null) {
						Dispecer noviDispecer = new Dispecer(idKorisnika, korisnickoIme, lozinka, ime, prezime, JMBG, adresa, pol, brojTelefona, false, plata, brojTelefonskeLinije, odeljenjeDispecer);
						taksiSluzba.dodajDispecera(noviDispecer);
						
					} else {    //IZMENA
						
						dispecer.setIdKorisnika(idKorisnika);
	...
	private void popuniPolja() {
		...
		txtRedniBrojKorisnika.setText(String.valueOf(dispecer.getIdKorisnika()));
