...
public class DodeljivanjeVoznjeVozacuUlogaDispecerForma extends JFrame {
	
	private JLabel lblObavestenje = new JLabel("Dobar dan. Molimo dodelite izabranu voznju jednom vozacu.");
	private JLabel lblUputstvo = new JLabel("Potrebno je odabrati vozaca i promeniti status voznje na DODELJENA: ");
	...
	private JButton btnDodeli = new JButton("Dodeli");
	
	private TaksiSluzba taksiSluzba;
	private Voznja voznja;
	
	public DodeljivanjeVoznjeVozacuUlogaDispecerForma(TaksiSluzba taksiSluzba, Voznja voznja) {
		this.taksiSluzba = taksiSluzba;
		this.voznja = voznja;
		
		setTitle("Dodela voznje -" + voznja.getIdVoznje());
		...
		btnDodeli.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (validacija()) {
					...
					JOptionPane.showMessageDialog(null, "Voznja je uspesno dodeljena!", "Obavestenje", JOptionPane.INFORMATION_MESSAGE);
					taksiSluzba.snimiVoznju(Main.VOZNJE_FAJL);
					DodeljivanjeVoznjeVozacuUlogaDispecerForma.this.dispose();
					DodeljivanjeVoznjeVozacuUlogaDispecerForma.this.setVisible(false);
